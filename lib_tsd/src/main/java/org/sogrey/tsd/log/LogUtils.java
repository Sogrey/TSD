 ...
 *     desc  : 日志相关工具类
 *
 *     LogUtils.Builder lBuilder = new LogUtils.Builder(context)
...
public final class LogUtils {
    ...
    private static /*int*/ TYPE sLogFilter = TYPE.v;    // log过滤器
    ...
    public static class Builder {
        ...
        public Builder setLogFilter(/*@TYPE int*/TYPE logFilter) {
    ...
    private static void log(int type, String tag, Object... contents) {
        ...
        switch (type) {
            ...
            case E:
            case A:
                if (V == sLogFilter.value || type >= sLogFilter.value) {
