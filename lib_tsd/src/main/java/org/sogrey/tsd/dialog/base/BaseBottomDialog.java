package org.sogrey.tsd.dialog.base;
 ...
 */
public abstract class BaseBottomDialog<T extends BaseBottomDialog<T>> extends BaseTopBottomDialog<T> {
    public BaseBottomDialog(Context context, View animateView) {
        super(context);
