...
import org.sogrey.tsd.snackbar.SnackBar;
...
//        Tt.makeText(this, "Button clicked!", Toast.LENGTH_LONG);
        new Tt.Builder(this,"Button clicked!")
                .withDuration(Toast.LENGTH_LONG)
                .withGravity(Gravity.TOP)
                .withBoldText()
                .withCornerRadius(5)
                .withIcon(R.mipmap.ic_launcher)
                .withTextColor(R.color.sb__button_text_color_green)
                .show();
    }
}